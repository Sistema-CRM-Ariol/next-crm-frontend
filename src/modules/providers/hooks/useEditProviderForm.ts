...
import { editProvider, type Provider } from '@/modules/providers';

export const useEditProviderForm = ( provider: Provider ) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const { data, error } = await editProvider( formData);
